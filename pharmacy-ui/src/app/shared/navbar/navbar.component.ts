...
import { User, Heart, ShoppingCart, Search, MapPin, Info, LucideAngularModule } from 'lucide-angular/src/icons';
...
export class NavbarComponent implements OnInit {
  ...
  // Icons object for template binding
  icons = { User, Heart, ShoppingCart, Search, MapPin, Info };
